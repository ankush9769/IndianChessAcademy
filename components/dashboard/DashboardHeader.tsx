                    ...
                    <>
                      <div className="pt-2 border-t border-gray-200">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center space-x-2 sm:space-x-3 text-xs sm:text-sm">
                            <User className="w-4 h-4 text-gray-500 flex-shrink-0" />
                            <span className="text-gray-900 font-semibold truncate">{userDetails.studentName}</span>
                          </div>
                          <div className="flex items-center space-x-2 sm:space-x-3 text-xs sm:text-sm">
                            <Award className="w-4 h-4 text-gray-500 flex-shrink-0" />
                            <span className="text-gray-900 font-medium">Rating: {userDetails.studentRating}</span>
                          </div>
                          <div className="flex items-center space-x-2 sm:space-x-3 text-xs sm:text-sm">
                            <User className="w-4 h-4 text-gray-500 flex-shrink-0" />
                            <span className="text-gray-900 font-medium">Age: {userDetails.studentAge} years</span>
                          </div>
                        </div>
                      </div>
                    </>
