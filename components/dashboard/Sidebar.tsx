...
const menuItems = {
  parent: [
    ...
    { icon: TrendingUp, label: 'Progress', href: '/dashboard/parent/progress' },
    { icon: CreditCard, label: 'Billing', href: '/dashboard/parent/billing' },
    { icon: MessageSquare, label: 'Messages', href: '/dashboard/parent/messages' },
    { icon: BookOpen, label: 'Resources', href: '/dashboard/parent/resources' },
    { icon: MessageSquare, label: 'Announcements', href: '/dashboard/parent/broadcast' },
  ],
  student: [
  ...
  coach: [
    ...
    { icon: Video, label: 'Recordings', href: '/dashboard/coach/recordings' },
        ...
        <div className="p-4 sm:p-6 border-b border-gray-200 mt-14 sm:mt-16">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-gray-600 capitalize truncate">{role} Portal</p>
            </div>
          </div>
        </div>
