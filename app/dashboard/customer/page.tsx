        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <h1 className="text-xl font-heading font-bold text-primary-blue">Indian Chess Academy</h1>
                <p className="text-sm text-gray-600">Welcome, {demoDetails.parentName}</p>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-heading font-semibold text-primary-blue">Your Demo Session</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4 p-4 bg-primary-offwhite rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-semibold text-lg" suppressHydrationWarning>
              ...
              <div className="flex items-start space-x-4 p-4 bg-primary-offwhite rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-semibold text-lg">{demoDetails.coach}</p>
                  <p className="text-gray-700">Rating: {demoDetails.coachRating}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 p-4 bg-primary-offwhite rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-semibold text-lg">{demoDetails.timezone}</p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <Card>
              <h3 className="text-lg font-heading font-semibold text-primary-blue mb-4">Student Details</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <User className="w-5 h-5 text-gray-600" />
                  <div>
                    <p className="text-sm text-gray-600">Student Name</p>
                    <p className="font-semibold">{demoDetails.studentName}</p>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <h3 className="text-lg font-heading font-semibold text-primary-blue mb-4">Contact Information</h3>
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <Mail className="w-5 h-5 text-gray-600 mt-0.5" />
                  <div className="min-w-0 flex-1">
                    <p className="text-sm text-gray-600">Email</p>
                    <p className="font-semibold text-sm break-all">{demoDetails.parentEmail}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{demoDetails.parentPhone}</p>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-orange-50 to-amber-50 border-orange-200">
              <h3 className="text-lg font-heading font-semibold text-primary-orange mb-2">What's Next?</h3>
