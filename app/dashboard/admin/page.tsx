...
const paymentPendingDemos = [
  { id: 1, student: 'Rohan Kumar', parent: 'Vikram Kumar', amount: '₹12,000', dueDate: '2026-01-20', status: 'interested' },
  { id: 2, student: 'Priya Singh', parent: 'Rajesh Singh', amount: '₹8,000', dueDate: '2026-01-19', status: 'following_up' },
  { id: 3, student: 'Lakshmi Rao', parent: 'Sunita Rao', amount: '₹15,000', dueDate: '2026-01-22', status: 'interested' },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <Card className="border-2 border-red-300">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge variant="danger">{pendingOutcomes.length}</Badge>
              </div>
                  ...
                  {pendingOutcomes.map(demo => (
                    <div key={demo.id} className="p-3 bg-red-50 rounded-lg">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        {demo.daysOverdue > 0 && (
                          <Badge variant="danger" className="flex-shrink-0 ml-2">
                ...
                {alerts.map(alert => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <Badge 
                        variant={alert.priority === 'urgent' ? 'danger' : alert.priority === 'high' ? 'warning' : 'info'}
