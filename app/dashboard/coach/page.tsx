...
import { Users, Calendar, Video, BookOpen, Clock, AlertCircle } from 'lucide-react';
...
const todaysClasses = [
  { time: '10:00 AM', type: 'Demo', student: 'Arjun Patel', topic: 'Introduction Session', hasLink: true, link: 'https://zoom.us/j/123456789' },
  { time: '02:00 PM', type: '1-1', student: 'Rohan Kumar', topic: 'Sicilian Defense', hasLink: true, link: 'https://zoom.us/j/987654321' },
  { time: '04:00 PM', type: 'Group', student: 'Beginners Batch A', topic: 'Chess Fundamentals', hasLink: false, link: '' },
];
                    ...
                    <div key={idx} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3 sm:p-4 bg-primary-offwhite rounded-lg">
                      <div className="flex items-start sm:items-center space-x-3 sm:space-x-4 min-w-0 flex-1 w-full">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs text-gray-600 truncate">{lesson.topic}</p>
                          {lesson.hasLink && (
